...
<div class="crud">
    <a href="${pageContext.request.contextPath}/PaginasCRUD/Cep/inserirCEP/index.jsp" id="criar">
    ...
    <a href="${pageContext.request.contextPath}/PaginasCRUD/Cep/readCEP/index.jsp" id="ler">
    ...
    <a href="${pageContext.request.contextPath}/PaginasCRUD/Cep/updateCEP/index.jsp" id="atualizar">
    ...
    <a href="${pageContext.request.contextPath}/PaginasCRUD/Cep/removeCEP/index.jsp" id="remover">
