...
<div class="content">
    <h1>Inserção de Parâmetros</h1>
        <form action="${pageContext.request.contextPath}/atualizarCEP" method="post">
        <div class="params">
            <h2>Informe o Cep antigo</h2>
            <input type="text" name="oldCep" required>
        </div>
        <div class="params">
            <h2>Informe o novo Cep:</h2>
            <input type="text" name="newCep" required>
        </div>
        <div class="send">
