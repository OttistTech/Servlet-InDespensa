...
<div class="titulo">
    <h1>Tabela PRODUCT</h1>
    <h2>Selecione a operação desejada</h2>
</div>

<div class="crud">
    <a href="${pageContext.request.contextPath}/PaginasCRUD/Product/inserirProduct/index.jsp" id="criar">
    ...
    <a href="${pageContext.request.contextPath}/PaginasCRUD/Product/lerPRODUCT/index.jsp" id="ler">
    ...
    <a href="${pageContext.request.contextPath}/PaginasCRUD/Product/atualizarPRODUCT/index.jsp" id="atualizar">
    ...
    <a href="${pageContext.request.contextPath}/PaginasCRUD/Product/removerPRODUCT/index.jsp" id="remover">
