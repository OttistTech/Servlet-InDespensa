package com.servletindespensa.daos;

import com.servletindespensa.util.Connection;
...
public class AdmDAO {
   ...
   private java.sql.Connection conn; // Custom connection class
   private com.servletindespensa.util.Connection connection;
