...
public class ProductDAO {
    ...
    public int insertProduct(int id, String desc, long barcode, String brand, String name, String type, double weight_volume) {
        try {
            ...
            // Prepara a instrução SQL para inserir o novo produto
    ...
    public int updateProduct(double weight_volume, int id) {
        try {
            ...
            // Prepara a instrução SQL para atualizar o weight_volume do produto
